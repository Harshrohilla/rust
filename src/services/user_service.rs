...
pub fn create_rust_user(conn: &mut PgConnection, new_rust_user: RustUser) -> Result<RustUser, diesel::result::Error> {
...
pub fn update_user(conn: &mut PgConnection, updated_user: RustUser) -> Result<RustUser, diesel::result::Error>{
